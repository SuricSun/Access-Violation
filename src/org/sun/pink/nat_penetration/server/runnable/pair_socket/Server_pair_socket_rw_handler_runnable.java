 ...
 * @date: 2022/7/25
 */
public class Server_pair_socket_rw_handler_runnable implements Runnable {
    ...
    public Server_pair_socket_rw_handler_runnable(Server server, SocketChannel ready_socket, SelectionKey ready_key, int ready_ops, Pair_socket pair_socket) {
    ...
    public boolean read() {
        ...
        try {
            ...
            Logger.Log("file", Logger.Log_type.Error, "Socket_pair断开连接", Logger.Stringify(e));
            this.pair_socket.self_cleanup();
            return false;
        }
        return true;
